...
#include "StillImagePlugin.h"

using namespace iop;
using namespace urn_jaus_jss_environmentSensing_StillImage;
...
StillImagePlugin::StillImagePlugin()
{
	p_my_service = NULL;
	p_base_service = NULL;
...
JTS::Service* StillImagePlugin::get_service()
{
	return p_my_service;
}

void StillImagePlugin::create_service(JTS::JausRouter* jaus_router)
{
	...
	p_my_service = new StillImageService(jaus_router, p_transport_service, p_events_service, p_accesscontrol_service, p_base_service);
}

PLUGINLIB_EXPORT_CLASS(iop::StillImagePlugin, iop::PluginInterface)
