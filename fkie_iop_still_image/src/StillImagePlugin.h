...
#ifndef STILLIMAGEPLUGIN_H
#define STILLIMAGEPLUGIN_H

#include "urn_jaus_jss_environmentSensing_StillImage/StillImageService.h"
...
class DllExport StillImagePlugin : public PluginInterface
{
public:
	StillImagePlugin();
...
protected:
	urn_jaus_jss_environmentSensing_StillImage::StillImageService *p_my_service;
