...
public:
    ...
    virtual void sendReportStillImageDataExtAction(QueryStillImageDataExt msg, Receive::Body::ReceiveRec transportData);
    virtual void sendReportStillImageDataExtInNativeSystemAction(QueryStillImageDataExt msg, Receive::Body::ReceiveRec transportData);
    ...
    virtual bool isCoordinateTransformSupported(QueryStillImageDataExt msg);
...
protected:
    ...
    public:
        ...
        ~ImageEndpoint();
        ReportStillImageDataExt report;
    ...
    bool is_requested_ext(unsigned short sensor_id, QueryStillImageDataExt& msg);
};
