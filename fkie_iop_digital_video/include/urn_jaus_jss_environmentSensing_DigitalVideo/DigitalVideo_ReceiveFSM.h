...
#include "urn_jaus_jss_environmentSensing_DigitalResourceDiscoveryClient/DigitalResourceDiscoveryClientService.h"
...
public:
    ...
    virtual void sendReportDigitalVideoSensorCapabilitiesExtAction(QueryDigitalVideoSensorCapabilitiesExt msg, Receive::Body::ReceiveRec transportData);
    ...
    virtual void sendReportDigitalVideoSensorStatusAction(QueryDigitalVideoSensorStatus msg, Receive::Body::ReceiveRec transportData);
    virtual void updateDigitalVideoSensorConfigurationAction(SetDigitalVideoSensorConfiguration msg);
    virtual void updateDigitalVideoSensorRecordingStateAction(ControlDigitalVideoSensorRecording msg);

    /// Guard Methods
    virtual bool isControllingClient(Receive::Body::ReceiveRec transportData);
    virtual bool isSupported(ControlDigitalVideoSensorRecording msg);
...
protected:
    ...
    urn_jaus_jss_environmentSensing_DigitalResourceDiscoveryClient::DigitalResourceDiscoveryClientService* p_ds_discovery_client_service;
