...
#ifndef DIGITALVIDEOPLUGIN_H
#define DIGITALVIDEOPLUGIN_H

#include "urn_jaus_jss_environmentSensing_DigitalVideo/DigitalVideoService.h"
...
class DllExport DigitalVideoPlugin : public PluginInterface
{
public:
	DigitalVideoPlugin();
...
protected:
	urn_jaus_jss_environmentSensing_DigitalVideo::DigitalVideoService *p_my_service;
	urn_jaus_jss_environmentSensing_VisualSensor::VisualSensorService *p_base_service;
