...
#ifndef RANGESENSORPLUGIN_1_0_H
#define RANGESENSORPLUGIN_1_0_H
...
class DllExport RangeSensorPlugin_1_0 : public PluginInterface
{
public:
	RangeSensorPlugin_1_0();
	...
	virtual ~RangeSensorPlugin_1_0();

	jVariableLengthString get_service_uri() { return "urn:jaus:jss:environmentSensing:RangeSensor"; }
	jUnsignedByte get_version_number_major() { return 1; }
	jUnsignedByte get_version_number_minor() { return 0; }

protected:
	urn_jaus_jss_environmentSensing_RangeSensor_1_0::RangeSensorService *p_my_service;
